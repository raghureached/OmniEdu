...
export const fetchGlobalAssessments = createAsyncThunk(
  ...
  async (filters, { rejectWithValue }) => {
    try {
      const response = await api.get('/api/admin/getAssessments', { params: filters });
...
export const searchGlobalAssessments = createAsyncThunk(
  ...
  async (params, { rejectWithValue }) => {
    try {
      const response = await api.get('/api/admin/getAssessments', { params });
...
export const deleteGlobalAssessment = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.delete(`/api/admin/deleteAssessment/${id}`);
...
export const createGlobalAssessment = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      console.log(payload);
      const response = await api.post('/api/admin/createAssessment', payload,{
        headers: {
...
export const updateGlobalAssessment = createAsyncThunk(
  ...
  async ({ id, data }, { rejectWithValue }) => {
    try {
      ...
      const response = await api.put(`/api/admin/editAssessment/${id}`, data,{
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
...
export const getGlobalAssessmentById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.get(`/api/admin/getAssessmentById/${id}`);
      return response.data.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchAssessmentQuestions = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.get(`/api/admin/getQuestions/${id}`);
...
export const fetchRandomAssessmentQuestions = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.get(`/api/admin/getQuestionsRandom/${id}`);
      return response.data.data; // array of questions
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const editAssessmentQuestion = createAsyncThunk(
  ...
  async ({ id, data }, { rejectWithValue }) => {
    try {
      const response = await api.put(`/api/admin/editQuestion/${id}`, data);
...
export const deleteAssessmentQuestion = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.delete(`/api/admin/deleteQuestion/${id}`);
...
export const uploadAssessmentCSV = createAsyncThunk(
  ...
  async (file, { rejectWithValue }) => {
    try {
      ...
      const response = await api.post('/api/admin/uploadAssessmentCSV', formData, {
...
export const uploadAssessmentFile = createAsyncThunk(
  ...
  async (file, { rejectWithValue }) => {
    try {
      const formData = new FormData();
      formData.append('file', file);
      const response = await api.post('/api/admin/uploadFile', formData, {
        headers: { 'Content-Type': 'multipart/form-data' }
      });
