                                    ...
                                    {/* <button 
                                       ...
                                       onClick={async () => {
                                           try {
                                               ...
                                               console.log('Enhancement complete, creating questions...');
                                               console.log('Values:', { 
                                                   title: formData.title, 
                                                   noOfQuestions: noOfQuestions, 
                                                   Level: Level 
                                               });
                                               await createAIQuestions(formData.title, noOfQuestions, Level);
                                           } catch (error) {
                                                                    ...
                                                                    <div key={optIndex} className="assess-option-row" style={{ display: 'flex', alignItems: 'center', gap: '10px', width: 'fit-content' }}>
                                                                        ...
                                                                        {q.options.length > 2 && (
                                                                            <button
                                                                                ...
                                                                                aria-label={`Remove option ${getLetterFromIndex(optIndex)}`}
                                                                            >
                                                                                <X size={16} />
                                                                            </button>
                                                                        )}
