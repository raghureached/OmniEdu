...
import { fetchSubmissions, gradeSubmission } from '../../../store/slices/globalAdminSubmissionsSlice';
...
const GradeSubmission = () => {
  ...
  const handleSaveGrade = () => {
    try {
      dispatch(gradeSubmission(selectedSubmission._id, gradeValue, feedback));
    } catch (error) {
