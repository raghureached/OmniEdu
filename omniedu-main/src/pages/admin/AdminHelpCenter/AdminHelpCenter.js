    ...
    <div className="admin-help-center">
      ...
      <div className="help-sections">
        <section className="help-section">
          ...
          <ul>
            <li>Overview of Admin Dashboard</li>
        ...
        <section className="help-section">
          ...
          <div className="faq-list">
            <details>
              ...
              <p>Navigate to Users Management, click "Add New User", and fill in the required information.</p>
            </details>
            <details>
              <summary>How do I assign content to groups?</summary>
              <p>Go to Content Modules, select the content, and use the "Assign" feature to select target groups.</p>
            </details>
            <details>
              <summary>How do I create learning paths?</summary>
              <p>Access Learning Paths section, click "Create New Path", and follow the step-by-step wizard.</p>
            </details>
          </div>
        </section>
        ...
        <section className="help-section">
          ...
          <div className="support-links">
            ...
            <a href="#" className="support-link">Video Tutorials</a>
